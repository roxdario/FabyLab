...
public class SeatInGui extends JFrame {
 ...
 //controlli per login
    ...
    public JPanel viewTree(Node node,String profile) throws IOException, NotBoundException {
        if (profile.equals("s"))
