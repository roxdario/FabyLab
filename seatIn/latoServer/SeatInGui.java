    ...
    public JPanel uploadResource(Node node) {
        ...
        up.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String nodeCode = "";
                for (Node n : s) {
                    if (n.getName().equals(section.getSelectedItem())) {
                ...
                boolean flag = true;
                int i = resourceType.getSelectedIndex();
                if (resourceName.getText().equals("") && !resourceType.getSelectedItem().toString().equals("File")) {
                        ...
                        case 4:
                            ...
                            if (destination.getSelectedItem().toString().equals("Sezione")) {
                                ...
                                try {
                                  ...
                                  flag= teacher.insertFile(nodeCode,"x.pdf",descriptionArea.getText(),array,nodeCode,type.getSelectedItem().toString(),"file");
                                  if (flag)
