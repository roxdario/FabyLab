...
public class SeatInGui extends JFrame {
    ...
    public JPanel loginInterface () throws RemoteException, NotBoundException {
    	...
    	final SeatInPeople user= new SeatInPeople();
        user.connection();
        ...
        ok.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
              ...
              //  mail= registerInformation[4].getText();
            	if(registerInformation[0].getText().equals("studente")){
            	    SeatInStudent user= new SeatInStudent();
                    user.setName(labelForReg[0].getText());
                    user.setSurname(labelForReg[1].getText());
                    user.setID(labelForReg[2].getText());
                    user.setEmail(labelForReg[3].getText());
                    user.setDegreeCourse(labelForReg[5].getText());
                    user.setEnrollmentYear(Integer.parseInt(labelForReg[6].getText()));
                    user.setCourseState(labelForReg[7].getText());
            	...
            	}else if(registerInformation[0].getText().equals("docente")){
            		 SeatInStudent user= new SeatInStudent();
            	...
            	}else if(registerInformation[0].getText().equals("amministratore")){
            		 SeatInStudent user= new SeatInStudent();
                     user.setName(registerInformation[0].getText());
                     user.setSurname(registerInformation[1].getText());
                     user.setID(registerInformation[2].getText());
